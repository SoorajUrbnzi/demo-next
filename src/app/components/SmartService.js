...
export default function SmartService() {
  ...
  return (
    <div className="bg-[#0A0A0A] text-white px-4 md:px-6 py-16 md:py-20 space-y-16 md:space-y-24 min-h-screen">
      ...
      {/* ================= FEATURED CARD ================= */}
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12 bg-black">
        
        {/* Image */}
        <div className="w-full md:w-1/2 mx-0 md:mx-10 my-0 md:my-10">
          <img
            src="/showcase.webp"
            alt="featured"
            className="rounded-lg w-full h-[220px] sm:h-[260px] md:h-[420px] object-contain bg-black"
          />
        </div>
