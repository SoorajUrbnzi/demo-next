...
export default function AboutSection() {
  return (
    <section className="bg-[#0a0a0a] text-white py-28 px-8 lg:px-20 relative overflow-hidden max-lg:py-16 max-lg:px-5">
      ...
      {/* neon accent */}
      <div className="absolute right-24 top-100 max-lg:right-4 max-lg:top-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-lg:gap-8">
          ...
          max-lg:relative max-lg:left-0 max-lg:mt-6">
            ...
            <p className="text-gray-400 mb-8 leading-7 max-w-xl max-lg:text-sm max-lg:leading-6">
            ...
            <p className="text-gray-400 mb-12 leading-7 max-w-xl max-lg:text-sm max-lg:leading-6 max-lg:mb-8">
