...
export default function ServerPortfolio() {
  ...
  return (
    <section className="bg-black text-white py-28 max-lg:py-16">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 max-lg:grid-cols-1 gap-10 max-lg:gap-6 px-4">
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <img
              src={project.image}
              alt=""
              className="w-full h-[660px] max-lg:h-[300px] object-cover transition duration-500 group-hover:scale-110"
            />
