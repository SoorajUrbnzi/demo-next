    ...
    <div className="bg-[#0A0A0A] text-white px-4 md:px-6 py-16 md:py-20 space-y-16 md:space-y-24 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 bg-black">
        ...
        <div className="w-full md:w-1/2 space-y-5 md:space-y-7">
          <div className="flex flex-wrap items-center gap-3 md:gap-4 text-gray-400 text-sm">
            <span>🏷 Business</span>
      ...
      <div className="group border border-gray-800 p-4 md:p-6 space-y-4 md:space-y-6 transition-all duration-300 hover:bg-lime-400 hover:border-lime-400 cursor-pointer">
        ...
        <div className="relative overflow-hidden">
          <img
            src={blog.image}
            alt="blog"
            className="w-full h-44 sm:h-48 md:h-56 object-cover transition duration-300 group-hover:scale-105"
          />
