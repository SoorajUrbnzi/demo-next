...
export default function InteractionService() {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-[#0A0A0A] text-white px-4 md:px-6 py-16 md:py-20 space-y-16 md:space-y-24 min-h-screen overflow-hidden"
    >
...
function Card({ blog }) {
  return (
    ...
    >
      <Link href={blog.link}>
        <div className="group border border-gray-800 p-5 md:p-6 space-y-5 md:space-y-6 transition-all duration-300 hover:bg-lime-400 hover:border-lime-400 cursor-pointer">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold leading-snug group-hover:text-black">
            {blog.title}
          </h2>
          ...
          <div className="relative overflow-hidden">
            <img
              src={blog.image}
              alt="blog"
              className="w-full h-44 sm:h-52 md:h-56 object-cover transition duration-300 group-hover:scale-105"
            />
