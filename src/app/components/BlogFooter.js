  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="text-center py-20 md:py-32 px-6">
        ...
        <h1 className="text-[48px] md:text-[120px] lg:text-[160px] font-extrabold text-lime-400 leading-none mb-6 md:mb-10">
          LET’S TALK
        </h1>

        <a
          href="mailto:hello@pentaclay.com"
          className="block text-[18px] md:text-[40px] lg:text-[60px] font-semibold text-gray-300 hover:text-lime-400 transition-colors duration-300 mb-12 md:mb-20 break-all"
        >
          hello@pentaclay.com
        </a>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-0 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12">
          ...
          <div>
            ...
            <div className="flex items-center border-b border-gray-700 pb-3">
              ...
              <button className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-lime-400 flex items-center justify-center text-black">
                →
              </button>
        ...
        {/* bottom line */}
        <div className="border-t border-gray-800 mt-14 md:mt-20 pt-6 text-gray-400 text-xs md:text-sm text-center md:text-left">
          © 2024 All rights for Pentaclay
        </div>

        {/* BIG BRAND TEXT */}
        <div className="w-full text-center overflow-hidden mt-6 md:mt-10">
          <h1 className="text-[60px] md:text-[180px] lg:text-[260px] font-extrabold text-gray-200 leading-none tracking-tight break-words">
            PENTOS
          </h1>
        </div>
